...
@Composable
fun InicioView(navController: NavController, viewModel: ProductViewModel){
    Scaffold(
        topBar = {
...
@Composable
fun ContentInicioView(it: PaddingValues, navController: NavController, viewModel: ProductViewModel){
    val state = viewModel.state

    Column(modifier = Modifier.padding(it)) {
        LazyColumn {
            items(state.listaProduct) { product ->
                Box(
                    modifier = Modifier
                        .padding(8.dp)
                        .fillMaxWidth()
                    ...
                    Box(
                        ...
                        Row(
                            ...
                            Column(
                                ...
                                IconButton(
                                    onClick = { navController.navigate("editar/${product.id}/${product.name}/${product.description}/${product.category}/${product.price}/${product.quantity}") }
                                ) {
                                    Icon(
                                ...
                                IconButton(
                                    onClick = { viewModel.borrarProduct(product) }
                                ) {
                                    Icon(
